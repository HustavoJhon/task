# SPEC DETALLADO - Especificación Funcional EsSalud v1.0 Flutter App
...
| Archivo | Relación |
|---------|----------|
| [[essalud/app/07_ROLES_PERMISOS]] | Matriz RBAC expandida y detalle de permisos |
| [[essalud/app/24_REQUISITOS_FUNCIONALES]] | Catálogo de requisitos funcionales con criterios de verificación |
| [[essalud/app/01_PLAN_DETALLADO]] | Plan estratégico con roadmap y fases |
| [[essalud/app/09_CASOS_USO_UML]] | Casos de uso detallados del sistema |
| [[18_OPENAPI_SWAGGER]] | Especificación de endpoints REST |
| [[essalud/app/11_RAG_QDRANT]] | Detalle del sistema RAG |
