...
| Archivo | Relación |
|---------|----------|
| [[essalud/app/03_DESIGN_DETALLADO]] | Decisiones arquitectónicas (ADR) detalladas |
| [[05_MICROSERVICIOS]] | Especificación de cada microservicio |
| [[essalud/app/06_MODELO_ER]] | Modelo de datos completo |
| [[essalud/app/17_DOCKER_COMPOSE]] | Infraestructura y deployment |
| [[essalud/app/11_RAG_QDRANT]] | Sistema RAG detallado |
