...
| Archivo | Relación |
|---------|----------|
| [[04_ARQUITECTURA_C4]] | Diagrama de contenedores y componentes |
| [[essalud/app/03_DESIGN_DETALLADO]] | ADR y patrones de diseño |
| [[essalud/app/17_DOCKER_COMPOSE]] | Configuración Docker de cada servicio |
| [[18_OPENAPI_SWAGGER]] | Especificación OpenAPI de endpoints |
| [[essalud/app/11_RAG_QDRANT]] | Detalle del servicio chatbot y RAG |
