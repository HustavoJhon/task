...
| # | Archivo | Descripción |
|---|---------|-------------|
| **00** | [[essalud/pwa/00_INDICE]] | Índice maestro con navegación centralizada de toda la documentación |
| **01** | [[essalud/pwa/01_PLAN_DETALLADO]] | Plan estratégico con roadmap de 22 semanas, objetivos SMART y KPIs para Laravel |
| **23** | [[essalud/pwa/23_MATRIZ_RIESGOS]] | Matriz de riesgos con estrategias de mitigación adaptadas a monolito |
| **22** | [[essalud/pwa/22_ROADMAP]] | Roadmap detallado con diagrama Gantt y hitos del proyecto |

### **SECCIÓN II: REQUISITOS Y ESPECIFICACIONES**

| # | Archivo | Descripción |
|---|---------|-------------|
| **02** | [[essalud/pwa/02_SPEC_DETALLADO]] | Especificación funcional: 50+ funcionalidades, RBAC, reglas de negocio |
| **24** | [[essalud/pwa/24_REQUISITOS_FUNCIONALES]] | Catálogo de 60+ requisitos funcionales por módulo |
| **25** | [[essalud/pwa/25_REQUISITOS_NO_FUNCIONALES]] | RNF: rendimiento, disponibilidad, escalabilidad, seguridad |
| **08** | [[essalud/pwa/08_HISTORIAS_USUARIO]] | 40+ historias de usuario con criterios de aceptación |

### **SECCIÓN III: DISEÑO Y ARQUITECTURA**

| # | Archivo | Descripción |
|---|---------|-------------|
| **03** | [[essalud/pwa/03_DESIGN_DETALLADO]] | UI/UX Blade + Livewire: Tailwind, componentes, pantallas, wireframes ASCII |
| **04** | [[04_ARQUITECTURA]] | Arquitectura monolito modular Laravel 11 con modelo C4 completo |
| **06** | [[essalud/pwa/06_MODELO_ER]] | Modelo entidad-relación con 30+ tablas y diagramas |
| **09** | [[essalud/pwa/09_CASOS_USO_UML]] | 15 casos de uso detallados con flujos principales y alternativos |
| **10** | [[essalud/pwa/10_DIAGRAMAS_SECUENCIA]] | 8 diagramas de secuencia UML para flujos críticos con Livewire |
...
| # | Archivo | Descripción |
|---|---------|-------------|
| **07** | [[essalud/pwa/07_ROLES_PERMISOS]] | RBAC con Spatie Permissions: matriz de permisos, estructura de roles |
| **11** | [[essalud/pwa/11_RAG_QDRANT]] | Sistema RAG: embedding, recuperación, prompt engineering |
| **12** | [[essalud/pwa/12_INGESTION_PDFS]] | Pipeline de ingestión de documentos con Laravel Jobs |
| **13** | [[essalud/pwa/13_VALIDACION_DOCUMENTOS]] | Reglas de validación, estados de documento, subsanaciones |
...
| # | Archivo | Descripción |
|---|---------|-------------|
| **14** | [[essalud/pwa/14_DASHBOARD_ADMIN]] | Dashboard administrativo con Filament: KPIs, alertas, exportación |
| **17** | [[essalud/pwa/17_DOCKER_COMPOSE]] | Docker Compose para dev, staging y producción (Laravel Sail) |
| **19** | [[essalud/pwa/19_CICD]] | Pipeline CI/CD con GitHub Actions, PHPStan, Pest, Laravel Pint |
| **20** | [[essalud/pwa/20_OBSERVABILIDAD]] | Stack Prometheus+Grafana+Loki, Laravel Telescope, Horizon |

### **SECCIÓN VIII: SEGURIDAD Y CALIDAD**

| # | Archivo | Descripción |
|---|---------|-------------|
| **21** | [[essalud/pwa/21_SEGURIDAD_AUDITORIA]] | Seguridad integral: OWASP, Sanctum, CSRF, Spatie, rate limiting, auditoría |

### **SECCIÓN IX: GESTIÓN DEL PROYECTO**

| # | Archivo | Descripción |
|---|---------|-------------|
| **26** | [[essalud/pwa/26_KANBAN_GANTT]] | Kanban central + Gantt interactivo para gestión de tareas |
...
1. Comienza con [[essalud/pwa/01_PLAN_DETALLADO]] para contexto estratégico
2. Revisa [[04_ARQUITECTURA]] para el diseño del monolito modular
3. Consulta [[essalud/pwa/03_DESIGN_DETALLADO]] para UI/UX con Blade + Livewire

### **Para Desarrolladores Backend (Laravel)**
1. Lee [[essalud/pwa/02_SPEC_DETALLADO]] para requisitos funcionales
2. Estudia [[05_MODULOS_LARAVEL.md]] y [[18_API_REST.md]]
3. Implementa según [[essalud/pwa/09_CASOS_USO_UML]] y [[essalud/pwa/10_DIAGRAMAS_SECUENCIA]]
4. Consulta [[essalud/pwa/07_ROLES_PERMISOS]] para autorización con Spatie
...
3. Consulta [[essalud/pwa/03_DESIGN_DETALLADO]] para wireframes y flujos de pantalla

### **Para DevOps e Infraestructura**
1. Implementa según [[essalud/pwa/17_DOCKER_COMPOSE]]
2. Configura CI/CD con [[essalud/pwa/19_CICD]]
3. Monitorea usando [[essalud/pwa/20_OBSERVABILIDAD]]

### **Para QA y Testing**
1. Revisa [[essalud/pwa/08_HISTORIAS_USUARIO]] para casos de prueba
2. Estudia [[essalud/pwa/09_CASOS_USO_UML]] y [[essalud/pwa/10_DIAGRAMAS_SECUENCIA]]
3. Implementa según [[essalud/pwa/19_CICD]] (quality gates con Pest + PHPStan)

### **Para Gestión del Proyecto**
1. Sigue el roadmap en [[essalud/pwa/22_ROADMAP]]
2. Monitorea riesgos en [[essalud/pwa/23_MATRIZ_RIESGOS]]
3. Actualiza tareas en [[essalud/pwa/26_KANBAN_GANTT]]
...
- **Roadmap Interactivo:** [[essalud/pwa/22_ROADMAP#Gantt]]
- **Gestión de Proyecto:** [[essalud/pwa/26_KANBAN_GANTT]]
- **Matriz de Riesgos:** [[essalud/pwa/23_MATRIZ_RIESGOS]]
- **Especificación API:** [[18_API_REST.md]]
- **Infraestructura:** [[essalud/pwa/17_DOCKER_COMPOSE]]
- **Seguridad:** [[essalud/pwa/21_SEGURIDAD_AUDITORIA]]
