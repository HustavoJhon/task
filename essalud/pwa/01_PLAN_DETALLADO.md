...
| Archivo | Relación |
|---------|----------|
| [[essalud/pwa/22_ROADMAP]] | Roadmap detallado con Gantt y milestones |
| [[essalud/pwa/23_MATRIZ_RIESGOS]] | Matriz de riesgos expandida |
| [[essalud/pwa/24_REQUISITOS_FUNCIONALES]] | Catálogo RF vinculados a fases |
| [[essalud/pwa/25_REQUISITOS_NO_FUNCIONALES]] | SLAs y métricas de performance |
| [[essalud/pwa/02_SPEC_DETALLADO]] | Especificación funcional completa |
| [[04_ARQUITECTURA]] | Arquitectura del monolito modular |
| [[essalud/pwa/03_DESIGN_DETALLADO]] | UI/UX Blade + Livewire |
| [[essalud/pwa/26_KANBAN_GANTT]] | Gestión de tareas y sprints |
