...
| Archivo | Relación |
|---------|----------|
| [[essalud/pwa/07_ROLES_PERMISOS]] | Matriz RBAC expandida con Spatie y detalle de permisos |
| [[essalud/pwa/24_REQUISITOS_FUNCIONALES]] | Catálogo de requisitos funcionales con criterios de verificación |
| [[essalud/pwa/01_PLAN_DETALLADO]] | Plan estratégico con roadmap de 8 fases y 22 semanas |
| [[essalud/pwa/09_CASOS_USO_UML]] | Casos de uso detallados del sistema |
| [[18_API_REST.md]] | Especificación de endpoints REST con Laravel Sanctum |
| [[essalud/pwa/11_RAG_QDRANT]] | Detalle del sistema RAG con Qdrant y OpenAI |
| [[04_ARQUITECTURA]] | Arquitectura del monolito modular Laravel |
